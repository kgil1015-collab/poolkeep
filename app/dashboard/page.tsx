          ...
          <>
            ...
            {(() => {
              ...
              const REPORT_PARAMS = [
                ...
                { key:'cya',              label:'Cyanuric Acid',    short:'CYA',  unit:'ppm', displayMin:0,   displayMax:120,  goodLow:30,   goodHigh:50,   warnLow:20,   warnHigh:100,  rangeLabel:'30 – 50 ppm',    hardWater:false },
