      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-2xl p-8">
        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <input type="password" placeholder="••••••••" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:border-pool-dark focus:ring-2 focus:ring-pool-dark/10 transition-all bg-surface" />
          </div>
          <button type="submit" className="w-full bg-pool-dark text-white font-bold py-3 rounded-xl hover:opacity-90 transition-opacity text-sm mt-2">
            Sign In →
          </button>
        </form>
