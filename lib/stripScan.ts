...
export const STRIP_PARAMS: StripParamMeta[] = [
  ...
  { key: 'free_chlorine',    label: 'Free Chlorine',       short: 'FC',  unit: 'ppm', decimals: 1 },
  { key: 'total_alkalinity', label: 'Total Alkalinity',    short: 'TA',  unit: 'ppm', decimals: 0 },
  { key: 'cya',              label: 'Cyanuric Acid',       short: 'CYA', unit: 'ppm', decimals: 0 },
  { key: 'calcium_hardness', label: 'Water Hardness',      short: 'CH',  unit: 'ppm', decimals: 0 },
]
...
const PIN_STORAGE_KEY = 'poolkeep_strip_pin_positions'

export function loadSavedPins(): Record<PinKey, PinPosition> {
...
export function savePins(pins: Record<PinKey, PinPosition>) {
